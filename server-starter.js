...
// A: so that personal info is safe even if someone gets db access.

// Q2: Can you reverse a bcrypt hash to get the original password?
// A: no

// Q3: What does the number 10 in bcrypt.hash(password, 10) mean?
// A: it's how many times the password is salted

// Q4: Why do we use bcrypt.compare() instead of comparing strings directly?
// A: because we would be comparing plain text to a hash. bcrypt.compare() first hashes the input password and then compares

// Q5: What happens if two users have the same password?
// A: they will have different hashes, so even in the databases they will not look the same.
// ============================================================================
